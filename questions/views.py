...
from .models import Question, Choice, TriviaFeedback
    ...
    def post(self, request):
        try:
            ...
            for data in json_data['data']:
                feedback = TriviaFeedback(question=Question.objects.get(id=data['question']), choice=Choice.objects.get(id=data['choice']), user=request.user)
                feedback.save()
